...
def create_data_lists(voc07test_path, voc07trainval_path, voc12trainval_path, output_folder):
    """
    ...
    print()
    print('CREATING TRAIN JSON DATA ...')
    # Save to file
